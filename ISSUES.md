...
3.  **Traefik Refactor**: Switched Traefik to `type: LoadBalancer` and disabled `hostNetwork`. It now receives a dedicated static IP (`100.54.30.247`) from MetalLB, improving isolation and scalability.
