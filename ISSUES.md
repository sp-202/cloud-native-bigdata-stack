...
3.  **Traefik Refactor**: Switched Traefik to `type: LoadBalancer` and disabled `hostNetwork`. It now receives a dedicated static IP (`3.239.107.222`) from MetalLB, improving isolation and scalability.
